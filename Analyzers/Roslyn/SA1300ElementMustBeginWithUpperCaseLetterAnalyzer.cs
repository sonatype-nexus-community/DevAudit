...
namespace DevAudit.AuditLibrary.Analyzers
{
    ...
    {
        #region Constructors
        public SA1300ElementMustBeginWithUpperCaseLetterAnalyzer(ScriptEnvironment script_env, object workspace, object project, object compilation) : base(script_env, "SA1300ElementMustBeginWithUpperCaseLetter", workspace, project, compilation)
        {

...
namespace DevAudit.CommandLine
{
    class Options
    {
        ...
        */
        ...
        [Option("iqserver", Required = false, HelpText = "Specify a set of comma delimited options to use the Sonatype IQ Server audit reporter. You must specify 3 options: Url=<url>,User=<user>,Pass=<pass> for the IQ Server url, user, and password.")]
